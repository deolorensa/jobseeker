        ...
        <main id="main-content" class="container mx-auto ">
            <div class="flex flex-col gap-y-10">
                <div>
                    ...
                    <h1 class="font-semibold text-[32px] text-slate-700 mb-4">Add Candidate</h1>
                        ...
                        <ol class="inline-flex items-center gap-x-2.5">
                            ...
                            <li aria-current="page">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-gray-400">Add Candidate</span>
                                </div>
                            </li>
                        </ol>
                    </nav>
                ...
                <div class="flex flex-col gap-y-5 max-w-[600px] max-sm:w-full">
                    <p class="font-medium text-slate-600 text-xl">Add Candidate data</p>
                    <form method="POST" action="{{ route('candidate.store') }}" autocomplete="off" enctype="multipart/form-data" class="flex flex-col gap-y-6 max-w-3xl">
                        @csrf
                        <div class="flex flex-col bg-white rounded-xl shadow-xl">
                            ...
                            <div class="flex flex-col p-5 gap-5">
                                <div>
                                    ...
                                    <input name="email" value="{{ old('email') }}" type="email" min="0" id="email" class="bg-white border border-gray-300 text-sm rounded-lg block w-full p-2.5" placeholder="Input Email">
                                    @error('email')
                                ...
                                <div>
                                    ...
                                    <input name="phone_number" value="{{ old('phone_number') }}" type="number" min="0" id="phone_number" class="bg-white border border-gray-300 text-sm rounded-lg block w-full p-2.5" placeholder="Input Phone Number">
                                    @error('phone_number')
                                        <div class="mt-2 capitalize-first text-sm text-red-600">
                                            {{ $message }}
                                        </div>
                                ...
                                <div>
                                    ...
                                    <input name="full_name" value="{{ old('full_name') }}" type="text" min="0" id="full_name" class="bg-white border border-gray-300 text-sm rounded-lg block w-full p-2.5" placeholder="Input Full Name">
                                    @error('full_name')
                                        <div class="mt-2 capitalize-first text-sm text-red-600">
                                            {{ $message }}
                                        </div>
                                ...
                                <div>
                                    ...
                                    <input name="dob" value="{{ old('dob') }}" type="date" min="0" id="dob" class="bg-white border border-gray-300 text-sm rounded-lg block w-full p-2.5" placeholder="Input Day of Birth">
                                    @error('dob')
                                        <div class="mt-2 capitalize-first text-sm text-red-600">
                                            {{ $message }}
                                        </div>
                                ...
                                <div>
                                    ...
                                    <input name="pob" value="{{ old('pob') }}" type="text" min="0" id="pob" class="bg-white border border-gray-300 text-sm rounded-lg block w-full p-2.5" placeholder="Input Place of Birth">
                                    @error('pob')
                                        <div class="mt-2 capitalize-first text-sm text-red-600">
                                            {{ $message }}
                                        </div>
                                ...
                                <div>
                                    ...
                                    <input name="year_exp" value="{{ old('year_exp') }}" type="number" min="0" id="year_exp" class="bg-white border border-gray-300 text-sm rounded-lg block w-full p-2.5" placeholder="Input Year Experience">
                                    @error('year_exp')
                                        <div class="mt-2 capitalize-first text-sm text-red-600">
                                            {{ $message }}
                                        </div>
                                ...
                                <div>
                                    ...
                                    <input name="last_salary" value="{{ old('last_salary') }}" type="number" min="0" id="last_salary" class="bg-white border border-gray-300 text-sm rounded-lg block w-full p-2.5" placeholder="Input Last Salary">
                                    @error('last_salary')
                                        <div class="mt-2 capitalize-first text-sm text-red-600">
                                            {{ $message }}
                                        </div>
